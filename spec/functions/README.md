...
once. This is the prime candidate for the **codegen middle path**: generate per-language
stubs from the shared definition rather than hand-writing N times. It is **descriptive of
the implemented operators**, not aspirational, and grows one entry per feature. The *why*
— the schema, truth-value result types, NULL propagation vs detection — lives in
