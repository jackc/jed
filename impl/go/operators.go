...
var operators = []operatorDesc{
	...
	},
	{
		...
		Kind:          "function",
		Arity:         6,
		ArgFamilies:   []string{"integer", "integer", "integer", "integer", "integer", "float"},
		ArgResolution: "none",
		Result:        "timestamp",
		Null:          "propagates",
		Precedence:    0,
		Errors:        []string{"22008"},
		ArgNames:      []string{"year", "month", "mday", "hour", "min", "sec"},
		ArgDefaults:   []string{},
		Volatility:    "immutable",
		Variadic:      false,
		Cost:          0,
	...
	},
	{
		...
		Kind:          "function",
		Arity:         7,
		ArgFamilies:   []string{"integer", "integer", "integer", "integer", "integer", "float", "text"},
		ArgResolution: "none",
		Result:        "timestamptz",
		Null:          "propagates",
		Precedence:    0,
		Errors:        []string{"22008", "22023"},
		ArgNames:      []string{"year", "month", "mday", "hour", "min", "sec", "timezone"},
		ArgDefaults:   []string{},
		Volatility:    "stable",
		Variadic:      false,
		Cost:          0,
	},
	{
		...
		Precedence:    0,
		Errors:        []string{"22008"},
		ArgNames:      []string{"year", "month", "day"},
		ArgDefaults:   []string{},
		Volatility:    "immutable",
		Variadic:      false,
		Cost:          0,
	...
	},
	{
		...
		Kind:          "function",
		Arity:         2,
		ArgFamilies:   []string{"text", "date"},
		ArgResolution: "none",
		Result:        "f64",
		Null:          "propagates",
		Precedence:    0,
		Errors:        []string{"22023", "0A000", "22008"},
		ArgNames:      []string{},
		ArgDefaults:   []string{},
		Volatility:    "immutable",
		Variadic:      false,
	...
	},
	{
		...
		Kind:          "function",
		Arity:         2,
		ArgFamilies:   []string{"text", "timestamp"},
		ArgResolution: "none",
		Result:        "f64",
		Null:          "propagates",
		Precedence:    0,
	...
	},
	{
		...
		Kind:          "function",
		Arity:         2,
		ArgFamilies:   []string{"text", "timestamptz"},
		ArgResolution: "none",
		Result:        "f64",
		Null:          "propagates",
		Precedence:    0,
	...
	},
	{
		...
		Kind:          "function",
		Arity:         2,
		ArgFamilies:   []string{"text", "interval"},
		ArgResolution: "none",
		Result:        "f64",
		Null:          "propagates",
		Precedence:    0,
