...
func TestCompositeKeyOrdersByTuple(t *testing.T) {
	...
	for _, stmt := range []string{
		...
		if _, err := db.Execute(stmt, nil); err != nil {
...
func TestCompositeUniquenessIsTheWholeTuple(t *testing.T) {
	...
	if _, err := db.Execute("INSERT INTO t VALUES (1, 2)", nil); err != nil {
...
func TestCompositeDDLErrorsMatchPostgresAndNarrowings(t *testing.T) {
	...
	if _, err := db.Execute("CREATE TABLE fpk (a i32, s f64, PRIMARY KEY (a, s))", nil); err != nil {
	...
	if _, err := db.Execute("CREATE TABLE rev (a i32, b i32, PRIMARY KEY (b, a))", nil); err != nil {
	...
	if _, err := db.Execute("INSERT INTO rev VALUES (1, 20), (2, 10), (3, 15)", nil); err != nil {
	...
	if _, err := db.Execute("CREATE TABLE ok (a i32, PRIMARY KEY (a))", nil); err != nil {
...
func TestCompositeRoundTripsThroughTheOnDiskImage(t *testing.T) {
	...
	if _, err := loaded.Execute("INSERT INTO t VALUES (2, 2, 50)", nil); err != nil {
