...
func (s *tableStore) Insert(key []byte, row storedRow) (bool, error) {
	src := s.leafSrc()
...
func (s *tableStore) Get(key []byte) (storedRow, bool, error) {
...
func (s *tableStore) IterInKeyOrder() ([]storedRow, error) {
...
func (s *tableStore) WriteCompressUnits(key []byte, row storedRow) int {
...
func (s *tableStore) resolveColumns(row storedRow, mask []bool) (storedRow, error) {
	needs := false
	for i, v := range row {
...
func (s *tableStore) resolveAll(row storedRow) (storedRow, error) {
