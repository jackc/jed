...
func uqRun(t *testing.T, db *Database, sql string) Outcome {
	t.Helper()
...
func uqCost(t *testing.T, db *Database, sql string) int64 {
	t.Helper()
	return uqRun(t, db, sql).Cost
}

func uqIds(t *testing.T, db *Database, sql string) []int64 {
	t.Helper()
	o := uqRun(t, db, sql)
...
func uqErr(t *testing.T, db *Database, sql string) (string, string) {
	t.Helper()
...
func uqNames(t *testing.T, db *Database, table string) []string {
	t.Helper()
