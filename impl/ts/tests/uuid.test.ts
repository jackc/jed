...
test("uuid_extract_timestamp returns micros for v1/v7 only", () => {
  assert.equal(
    uuidExtractTimestampMicros(u("0190b6f7-8000-7000-8000-000000000000")),
    1_721_056_591_872_000n,
  );
  assert.equal(
    uuidExtractTimestampMicros(u("c232ab00-9414-11ec-b3c8-9e6bdeced846")),
    1_645_557_742_000_000n,
  );
  // v1 sub-microsecond 100-ns ticks are truncated.
  assert.equal(
    uuidExtractTimestampMicros(u("c232ab07-9414-11ec-b3c8-9e6bdeced846")),
    1_645_557_742_000_000n,
  );
