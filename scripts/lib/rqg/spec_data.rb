...
module RQG
  ...
  module SpecData
    ...
    CAPS = {
      ...
      join_inner: "query.join_inner",
      cross_join: "query.cross_join",
      table_alias: "query.table_alias",
      qualified_column: "query.qualified_column",
      aggregates: "query.aggregates",
      group_by: "query.group_by",
      having: "query.having",
      subquery_in: "query.subquery_in",
      subquery_exists: "query.subquery_exists",
      subquery_scalar: "query.subquery_scalar",
      union: "query.union",
